...
TEXT = {
    ...
    "why": "🧠 Why did the AI predict this?",
    "about": "🤖 About the AI",
    "ai_info_1": "HeatShield AI uses a Random Forest machine-learning model trained on weather observations containing temperature, humidity, and wind speed.",
    "ai_info_2": "The model evaluates current weather conditions to classify heat risk and estimate its prediction confidence. HeatShield AI then combines the machine-learning prediction with a heat-risk score, live weather data, and hyperlocal temperature intelligence from the FortyGuard Temperature API to provide an understandable assessment of heat risk. The goal is to turn complex environmental data into clear, practical information that can help people recognize heat risk and make safer decisions.",
    ...
    "why": "🧠 لماذا توقع الذكاء الاصطناعي ذلك؟",
    "about": "🤖 حول الذكاء الاصطناعي",
    "ai_info_1": "يستخدم HeatShield AI نموذجًا للتعلم الآلي من نوع Random Forest تم تدريبه باستخدام بيانات جوية تتضمن درجة الحرارة والرطوبة وسرعة الرياح.",
    "ai_info_2": "يقيّم النموذج الظروف الجوية الحالية لتصنيف مستوى خطر الحرارة وتقدير مدى ثقة النموذج في توقعه. ثم يجمع HeatShield AI بين توقع التعلم الآلي ودرجة خطر الحرارة وبيانات الطقس المباشرة ومعلومات درجات الحرارة المحلية الدقيقة من واجهة FortyGuard Temperature API لتقديم تقييم واضح ومفهوم لخطر الحرارة. الهدف هو تحويل البيانات البيئية المعقدة إلى معلومات واضحة وعملية تساعد الأشخاص على التعرف على مخاطر الحرارة واتخاذ قرارات أكثر أمانًا.",
    "low": "منخفض",
    "moderate": "متوسط",
    "high": "مرتفع",
    "extreme": "شديد",
    ...
    "why": "🧠 ¿Por qué la IA hizo esta predicción?",
    "about": "🤖 Sobre la IA",
    "ai_info_1": "HeatShield AI utiliza un modelo de aprendizaje automático Random Forest entrenado con observaciones meteorológicas que contienen temperatura, humedad y velocidad del viento.",
    "ai_info_2": "El modelo evalúa las condiciones meteorológicas actuales para clasificar el nivel de riesgo por calor y estimar la confianza de su predicción. HeatShield AI combina la predicción del aprendizaje automático con una puntuación de riesgo térmico, datos meteorológicos en tiempo real e información hiperlocal de temperatura proporcionada por la API de Temperatura de FortyGuard para ofrecer una evaluación clara y comprensible del riesgo por calor. El objetivo es convertir datos ambientales complejos en información clara y práctica que ayude a las personas a reconocer el riesgo por calor y tomar decisiones más seguras.",
    "moderate": "MODERADO",
    "high": "ALTO",
    "extreme": "EXTREMO",
    ...
    "why": "🧠 Pourquoi l'IA a-t-elle fait cette prédiction ?",
    "about": "🤖 À propos de l'IA",
    "ai_info_1": "HeatShield AI utilise un modèle d’apprentissage automatique Random Forest entraîné à partir d’observations météorologiques comprenant la température, l’humidité et la vitesse du vent.",
    "ai_info_2": "Le modèle évalue les conditions météorologiques actuelles afin de classer le niveau de risque lié à la chaleur et d’estimer la confiance de sa prédiction. HeatShield AI combine ensuite la prédiction du modèle avec un score de risque thermique, des données météorologiques en temps réel et des informations hyperlocales sur la température fournies par l’API Temperature de FortyGuard afin de proposer une évaluation claire et compréhensible du risque lié à la chaleur. L’objectif est de transformer des données environnementales complexes en informations claires et pratiques qui aident les personnes à reconnaître les risques liés à la chaleur et à prendre des décisions plus sûres.",
    "low": "FAIBLE",
    "moderate": "MODÉRÉ",
    "high": "ÉLEVÉ",
    "extreme": "EXTRÊME",
    ...
    "why": "🧠 AI ने यह अनुमान क्यों लगाया?",
    "about": "🤖 AI के बारे में",
    "ai_info_1": "HeatShield AI एक Random Forest मशीन-लर्निंग मॉडल का उपयोग करता है, जिसे तापमान, आर्द्रता और हवा की गति से संबंधित मौसम संबंधी अवलोकनों पर प्रशिक्षित किया गया है।",
    "ai_info_2": "मॉडल वर्तमान मौसम की स्थितियों का मूल्यांकन करके गर्मी के जोखिम को वर्गीकृत करता है और अपनी भविष्यवाणी के विश्वास स्तर का अनुमान लगाता है। इसके बाद HeatShield AI मशीन-लर्निंग भविष्यवाणी को हीट-रिस्क स्कोर, लाइव मौसम डेटा और FortyGuard Temperature API से प्राप्त हाइपरलोकल तापमान जानकारी के साथ जोड़कर गर्मी के जोखिम का एक स्पष्ट और समझने योग्य आकलन प्रदान करता है। इसका उद्देश्य जटिल पर्यावरणीय डेटा को स्पष्ट और व्यावहारिक जानकारी में बदलना है, जिससे लोगों को गर्मी के जोखिम को पहचानने और अधिक सुरक्षित निर्णय लेने में मदद मिल सके।",
    "low": "कम",
    "moderate": "मध्यम",
    "high": "उच्च",
    "extreme": "अत्यधिक",
    ...
    "why": "🧠 AI نے یہ پیش گوئی کیوں کی؟",
    "about": "🤖 AI کے بارے میں",
    "ai_info_1": "HeatShield AI ایک Random Forest مشین لرننگ ماڈل استعمال کرتا ہے، جسے درجہ حرارت، نمی اور ہوا کی رفتار پر مشتمل موسمی مشاہدات کے ذریعے تربیت دی گئی ہے۔",
    "ai_info_2": "یہ ماڈل موجودہ موسمی حالات کا جائزہ لے کر گرمی کے خطرے کی درجہ بندی کرتا ہے اور اپنی پیش گوئی کے اعتماد کی سطح کا اندازہ لگاتا ہے۔ اس کے بعد HeatShield AI مشین لرننگ کی پیش گوئی کو ہیٹ رسک اسکور، لائیو موسمی ڈیٹا اور FortyGuard Temperature API سے حاصل کردہ ہائپرلوکل درجہ حرارت کی معلومات کے ساتھ ملا کر گرمی کے خطرے کا ایک واضح اور قابلِ فہم جائزہ فراہم کرتا ہے۔ اس کا مقصد پیچیدہ ماحولیاتی ڈیٹا کو واضح اور عملی معلومات میں تبدیل کرنا ہے تاکہ لوگوں کو گرمی کے خطرے کو سمجھنے اور زیادہ محفوظ فیصلے کرنے میں مدد مل سکے۔",
    "low": "کم",
    "moderate": "درمیانہ",
    "high": "زیادہ",
    "extreme": "انتہائی",
    ...
    "why": "🧠 AI 为什么做出这个预测？",
    "about": "🤖 关于 AI",
    "ai_info_1": "HeatShield AI 使用 Random Forest（随机森林）机器学习模型，该模型基于包含温度、湿度和风速的天气观测数据进行训练。",
    "ai_info_2": "该模型会评估当前天气状况，对高温风险进行分类，并估算预测结果的置信度。随后，HeatShield AI 将机器学习预测结果与高温风险评分、实时天气数据以及 FortyGuard Temperature API 提供的超本地温度信息相结合，从而提供清晰易懂的高温风险评估。其目标是将复杂的环境数据转化为清晰、实用的信息，帮助人们识别高温风险并做出更安全的决定。",
    "low": "低",
    "moderate": "中等",
    "high": "高",
    "extreme": "极高",
                ...
                if result.get("fortyguard_error"):
                    ...
                    if fortyguard_error:
                        ...
                        if stats.get("n_cells", 0) == 0:
                            st.info(
                                "FortyGuard completed the analysis, "
                                "but no thermal cells were returned for "
                                "this request."
                            )
                        else:
